...
module.exports = function (opcua) {
    ...
    * @param {object} [options.submodelOf] The parent AASType containing the Submodel by means of HasAsset reference.
    ...
    */
    opcua.AddressSpace.prototype.addSubmodel = function(options) {
        ...
        if (typeof options.submodelOf !== "undefined") {
            assert(options.submodelOf instanceof opcua.UAObject, "options.assetOf is not a UAObject.");
