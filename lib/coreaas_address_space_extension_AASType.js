    ...
    opcua.AddressSpace.prototype.addAssetAdministrationShell = function(options) {
        ...
        if (typeof options.derivedFromRef !== "undefined") {
            ...
            if (Array.isArray(options.derivedFromRef)) {
                ...
                options.derivedFromRef.forEach(el => assert(el.constructor.name === "Key", "options.derivedFromRef Array contains an element that is not a Key."));
        ...
        if (typeof options.assetRef !== "undefined") {
            ...
            if (Array.isArray(options.assetRef)) {
                ...
                options.assetRef.forEach(el => assert(el.constructor.name === "Key", "options.assetRef Array contains an element that is not a Key."));
