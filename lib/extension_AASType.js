...
module.exports = function (opcua) {
    ...
    */
    opcua.AddressSpace.prototype.addAssetAdministrationShell = function(options) {
        ...
        opcua.coreaas.identifiableMap.set(options.identification.id, aas);
        ...
        aas.addSubmodelRef = (submodelRef) => {
            assert(Array.isArray(submodelRef) || submodelRef instanceof opcua.UAObject, "options.submodelRef is neither a UAObject or an Array of Key.");
            
            if (Array.isArray(submodelRef)) {
                ...
                assert(submodelRef.coreAASType === "AASReferenceType", "submodelRef is not an AASReferenceType instance.");
