...
exports.install = function(opcua) {
    ...
    require("./coreaas_address_space_extension_AssetType")(opcua);
    ...
    require("./coreaas_address_space_extension_SubmodelType")(opcua);
    require("./coreaas_address_space_extension_SubmodelPropertyType")(opcua);
    require("./coreaas_address_space_extension_AdministrativeInformationType")(opcua);
    require("./coreaas_address_space_extension_ConceptDictionaryType")(opcua);
    require("./coreaas_address_space_extension_ConceptDescriptionType")(opcua);
