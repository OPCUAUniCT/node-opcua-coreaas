...
const schema_helpers =  require("node-opcua-factory/dist/factories_schema_helpers");
const resolve_schema_field_types               = schema_helpers.resolve_schema_field_types;
const initialize_field                         = schema_helpers.initialize_field;
const _defaultTypeMap = require("node-opcua-factory/dist/factories_builtin_types").getTypeMap();
const ec = require("node-opcua-basic-types");
const makeExpandedNodeId = require("node-opcua-nodeid/dist/expanded_nodeid").makeExpandedNodeId;
const generate_new_id = require("node-opcua-factory").generate_new_id;
const schema = require("../../schemas/Key_schema").Key_Schema;
const BaseUAObject = require("node-opcua-factory/dist/factories_baseobject").BaseUAObject;
...
module.exports = function (namespaceIndex = 1) {
    ...
    const encode_UInt32 = _defaultTypeMap.get("UInt32").encode;
    const decode_UInt32 = _defaultTypeMap.get("UInt32").decode;
    const encode_Boolean = _defaultTypeMap.get("Boolean").encode;
    const decode_Boolean = _defaultTypeMap.get("Boolean").decode;
    const encode_String = _defaultTypeMap.get("String").encode;
    const decode_String = _defaultTypeMap.get("String").decode;
    ...
    if (!_isRegistered) {
        const registerClassDefinition = require("node-opcua-factory/dist/factories_factories").registerClassDefinition;
        //registerClassDefinition("Key",Key);
        _isRegistered = true
    }  
