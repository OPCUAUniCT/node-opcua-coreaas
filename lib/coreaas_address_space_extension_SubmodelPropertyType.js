...
module.exports = function (opcua) {
    ...
    * @param {array} [options.hasSemantic] an Array of Key referencing to the Semantic element for the SubmodelProperty.
    ...
    * @param {array} [options.parent] an Array of Key referencing to parent element for the SubmodelProperty.
    * @param {string} [options.description] A description for the SubmodelProperty. 
    ...
    * @param {array} [options.valueId] an Array of Key referencing to the an external value for the SubmodelProperty. 
